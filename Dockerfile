...
FROM golang:1.15-alpine@sha256:a025015951720f3227acd51b0a99a71578b574a63172ea7d2415c60ae5e2bc0a AS yaml-patch
RUN apk add --update-cache --no-cache \
        git \
...
ARG KUBEONE_VERSION=v1.2.0-rc.1
