...
FROM golang:1.15-alpine@sha256:83bc732f33bf802af3f738ab5b19e0f77a1edabaf7e79a8e013101ca1dd37c35 AS yaml-patch
RUN apk add --update-cache --no-cache \
        git \
