...
FROM golang:1.15-alpine@sha256:91d400173a13aa29d25b0d9bcfa286544e2ad90bf9f0c0ef9a936dc3bf1173a0 AS yaml-patch
RUN apk add --update-cache --no-cache \
        git \
