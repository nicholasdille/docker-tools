...
FROM golang:1.15-alpine@sha256:e3a3969b7e0465c76b10a1948b27d11756886e7245d73a773283bdf89b8fd29f AS yaml-patch
RUN apk add --update-cache --no-cache \
        git \
...
ARG TERRAFORM_VERSION=v0.14.11
